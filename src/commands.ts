/**
 * Taken from https://community.bistudio.com/wiki/Category:Arma_3:_Scripting_Commands
 * `JSON.stringify([...document.querySelector('.mw-category-group').children[1].children].slice(18).map(x => x.textContent.replace(' ', '_')))`
 */
